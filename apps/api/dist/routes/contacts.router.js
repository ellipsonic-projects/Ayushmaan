...
exports.contactsRouter.post("/", (0, require_role_1.requireRole)("TENANT_ADMIN"), async (req, res) => {
    ...
    const contact = await (0, rls_context_1.withTenantContext)(req.tenantContext, async (tx) => {
        ...
        await (0, workflow_events_1.enqueueEventTriggers)(tx, req.params.tenantId, "CONTACT_CREATED", {
            contact: { id: created.id, fullName: created.fullName, type: created.type },
        });
        return created;
    });
