...
export function TenantCommercialCard({
  ...
  return (
    <Card size="sm" className="bg-foreground text-background ring-0">
      <CardContent className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-sm font-semibold tabular-nums">{mrr}</span>
        </div>
        <div className="flex items-center justify-between">
          <span className="text-xs uppercase tracking-wide opacity-70">
            ARR
          </span>
          <span className="text-sm font-semibold tabular-nums">{arr}</span>
        </div>
      </CardContent>
    </Card>
  );
