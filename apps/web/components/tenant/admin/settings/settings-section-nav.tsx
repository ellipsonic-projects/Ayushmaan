...
import { ImageIcon, Building2, Clock, Landmark, ShieldCheck, Users } from "lucide-react";
...
const sections: { id: string; label: string; icon: LucideIcon }[] = [
  ...
  { id: "consultant-fees", label: "Consultant Fees", icon: Users },
  { id: "weekly-recurring-time", label: "Weekly Recurring Time", icon: Clock },
