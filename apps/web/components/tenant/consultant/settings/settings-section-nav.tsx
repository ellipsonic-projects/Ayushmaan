    ...
    <nav className="flex gap-1 overflow-x-auto lg:sticky lg:top-6 lg:flex-col lg:overflow-visible">
      {sections.map(({ id, label, icon: Icon }) => (
        <button
          ...
          className={cn(
            "flex shrink-0 items-center gap-2.5 whitespace-nowrap rounded-md px-3 py-2 text-left text-sm font-semibold tracking-[-0.01em] text-muted-foreground transition-colors hover:bg-muted hover:text-foreground",
