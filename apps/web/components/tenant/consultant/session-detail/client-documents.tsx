...
import type { DocumentItem } from "@/components/tenant/consultant/session-detail/session-detail-data";
            ...
            <div className="flex min-w-0 items-center gap-2.5">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-muted-foreground">
                  {doc.fileType} &middot; {doc.sizeLabel} &middot; {format(doc.uploadedAt, "dd MMM yyyy")}
                </p>
              </div>
            </div>
