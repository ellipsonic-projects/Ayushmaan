...
import { sendInboxEmail } from "@/lib/api/inbox.client";
...
export function ComposeEmailDialog({
  ...
  async function handleSend() {
    ...
    try {
      ...
      setSendError("Couldn't send this email. Try again.");
    } finally {
      setSending(false);
    }
  }

  const recipientRow = "flex items-center gap-2 border-b border-border py-2 text-sm";
      ...
      >
        ...
        <div className="shrink-0 px-5">
          ...
          <div className="border-b border-border py-2">
            ...
            {!canSend && <p className="mt-1 text-xs text-destructive">This is required</p>}
          </div>
          {showCc && (
            <div className={recipientRow}>
