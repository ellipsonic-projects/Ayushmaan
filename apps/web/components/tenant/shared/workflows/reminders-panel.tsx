...
const initialGroups: ReminderGroup[] = [
  {
    ...
    reminders: [{ id: "appt-email", channel: "email", timing: "48 hours before appointment" }],
  },
  {
    id: "intake",
          ...
          <CardContent className="flex flex-col gap-3 p-4">
            <div className="flex items-center justify-between gap-2">
              <div className="flex min-w-0 items-center gap-2.5">
                ...
                <h3 className="truncate text-base font-semibold text-foreground">{group.title}</h3>
              </div>
              <button
                type="button"
            ...
            <div className="flex flex-col gap-2">
              {group.reminders.length === 0 ? (
                <div className="flex items-center gap-3 rounded-lg border border-border px-3 py-3">
                  ...
                  <span className="text-sm text-muted-foreground">No reminders configured</span>
                </div>
              ) : (
