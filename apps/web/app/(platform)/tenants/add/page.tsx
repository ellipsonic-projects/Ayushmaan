    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <h2 className="mt-1 text-2xl font-bold text-foreground">
          Provision New Practice
        </h2>
        <p className="mt-1 text-sm text-muted-foreground">
          Define the identity, domain infrastructure, and administrative
          ownership for the new medical practice.
        </p>
      </div>
        ...
        <CardContent className="flex flex-col gap-5">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              ...
              <Input id="practice-name" placeholder="e.g. Apollo Heart Centre" />
            </div>
            <div className="flex flex-col gap-1.5">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure how the practice will be accessed globally.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-5">
          <div className="flex flex-col gap-1.5">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Contact details for the initial TENANT_ADMIN account.
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select the subscription tier and payment structure.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="flex items-start gap-3 rounded-xl bg-muted/50 p-4 ring-1 ring-foreground/10">
        ...
        <div>
          ...
          <p className="mt-0.5 text-xs text-muted-foreground">
            Tenant creation triggers provisioning of dedicated cloud
            infrastructure, database schema, and an automated welcome email to
            the specified admin. This process typically completes within 90
            seconds.
          </p>
        </div>
      </div>
