...
export default function BookAppointmentPage() {
  ...
  const canContinue =
    (step === 1 && !!consultantId) || (step === 2 && !!date && !!time) || (step === 3 && paid);
    ...
    return (
      <div className="mx-auto flex max-w-lg flex-col items-center gap-4 py-16 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          at {time}. A receipt for ₹{consultant.fee.toLocaleString("en-IN")} has been sent to your
          email.
        </p>
    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-6">
                ...
                <CardContent className="flex flex-col gap-3">
                  ...
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    <span className="flex items-center gap-1">
                      ...
                      {c.rating} <span className="text-muted-foreground/70">({c.reviews})</span>
                    </span>
      ...
      {step === 2 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Booking with {consultant?.name}</CardDescription>
          </CardHeader>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col gap-4">
            <div className="flex items-center gap-3 rounded-lg border border-border p-3">
              ...
              <div className="min-w-0 leading-tight">
                <p className="truncate text-sm font-semibold text-foreground">{consultant.name}</p>
                <p className="mt-0.5 truncate text-xs text-muted-foreground">
      ...
      {step === 3 && consultant && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Consultation fee, paid securely via Stripe</CardDescription>
          </CardHeader>
          <CardContent className="flex flex-col gap-4">
            <div className="flex items-center justify-between rounded-lg border border-border p-3">
              <span className="text-sm text-muted-foreground">Session fee ({consultant.mode})</span>
      ...
      <div className="flex items-center justify-between">
        ...
        <Button type="button" onClick={goNext} disabled={!canContinue} className="gap-1.5">
          {step === 3 ? (paid ? "Confirm & Book" : "Pay to continue") : "Continue"}
