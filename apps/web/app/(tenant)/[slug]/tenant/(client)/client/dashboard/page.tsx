...
function AppointmentCard({ appointment }: { appointment: (typeof upcomingAppointments)[number] }) {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold text-foreground">Welcome back, Joker</h2>
