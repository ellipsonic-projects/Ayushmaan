...
async function main() {
  ...
  const consultants: { email: string; fullName: string; category: ConsultantCategory }[] = [
    { email: "consultant1@shekhar.com", fullName: "Dr. Anita Rao", category: "MEDICAL" },
    { email: "consultant2@shekhar.com", fullName: "Dr. Vikram Singh", category: "MEDICAL" },
    { email: "consultant3@shekhar.com", fullName: "Dr. Priya Nair", category: "MEDICAL" },
  ];
  ...
  for (const { email, fullName, category } of consultants) {
