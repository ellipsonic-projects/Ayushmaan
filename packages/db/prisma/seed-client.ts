...
async function main() {
  ...
  const clients: { email: string; fullName: string; phone: string }[] = [
    { email: "client1@shekhar.com", fullName: "Ramesh Gupta", phone: "+919652770460" },
    { email: "client2@shekhar.com", fullName: "Sunita Sharma", phone: "+919652770461" },
    { email: "client3@shekhar.com", fullName: "Arjun Mehta", phone: "+919652770462" },
  ];
  ...
  for (const { email, fullName, phone } of clients) {
