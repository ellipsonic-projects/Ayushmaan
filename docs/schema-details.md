...
CREATE TABLE documents (
  ...
  storage_path      TEXT          NOT NULL, -- cases/{tenantSlug}/{caseId}/... prefix, matching the Storage isolation rule
...
CREATE TABLE consultant_verification_documents (
  ...
  file_url          TEXT                  NOT NULL, -- Supabase Storage path, prefixed {tenantSlug}/{consultantId}/...
